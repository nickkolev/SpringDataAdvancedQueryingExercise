...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> findAllBooksContaining(String containingText) {
        return this.bookRepository.findByTitleContainingIgnoreCase(containingText);
    }

    @Override
    public List<Book> findAllBooksAuthorLastNameStartingWith(String lastNameStartsWith) {

        return this.bookRepository.findByAuthorLastNameStartingWithIgnoreCase(lastNameStartsWith);
    }
